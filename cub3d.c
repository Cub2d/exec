...
/*   Updated: 2022/11/09 16:34:08 by cjad             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	initialization(t_vars *vars, char **av)
{
	...
	vars->so = malloc(sizeof(t_data));
	vars->no = malloc(sizeof(t_data));
	vars->ea = malloc(sizeof(t_data));
	vars->we = malloc(sizeof(t_data));
	vars->mlx = mlx_init();
